...
console.log(velvociraptor.diet);
// How long was a stegosaurus?
console.log(); console.log(stegosaurus.length);
...
*/
const largerPopulation = zooAnimals.filter(currentValue => currentValue.population <= 4);
